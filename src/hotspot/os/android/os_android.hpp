...
#ifndef OS_ANDROID_OS_ANDROID_HPP
#define OS_ANDROID_OS_ANDROID_HPP
...
class os::Linux {
 ...
 public:
  ...
  static bool adjustStackSizeForGuardPages(); // See comments in os_android.cpp
...
#endif // OS_ANDROID_OS_ANDROID_HPP
